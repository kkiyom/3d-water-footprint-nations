...
const content = {
  ...
  en: {
    ...
    body: <>
      ...
      This work visualizes each nation's water footprint as a tangible sense of volume —
      the greater the water burden, the larger and darker the sphere.
      <br /><br />
